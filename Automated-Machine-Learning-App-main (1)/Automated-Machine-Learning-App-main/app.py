...
SOURCE_DATA_PATH = BASE_DIR / "sourcedata.csv"
MODEL_PATH = BASE_DIR / "best_model.pkl"

st.set_page_config(page_title="Data Science Platform", page_icon="🚀", layout="wide")
...
if SOURCE_DATA_PATH.exists():
    df = pd.read_csv(SOURCE_DATA_PATH, index_col=None)
else:
    df = pd.DataFrame()
